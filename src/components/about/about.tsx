  ...
  return (
    <div className='about' id='about'>
      ...
      <div className='about__biography'>
        ...
        <article>
          <p>
            Ukończyłem studia inżynierskie na kierunku informatyki, na wydziale
          ...
          <p>
            Moje doświadczenie opiera się o rok tworzenia własnych projektów
            oraz 4 miesiącach pracy jako fullstack developer. W pracy byłem
            odpowiedzialny głównie za poprawienie starego kodu oraz tworzenie
            nowych funkcjonalności po stronie frontendu (React.js) wraz z
            testami. Zadania polegały również na wprowadzaniu drobnych poprawek
            oraz pisaniu testów po stronie backendu (Django).
          </p>
          <p>
            Aktualnie uczę się pisać witryny internetowe przy pomocy technologii
            Gatsby.js jako frontend oraz systemu Wordpress jako backend.
          </p>
        </article>
          ...
          <div className='about__languages'>
            ...
            {languages &&
              languages.map((lang: ILanguage) => (
                <div className='about__languages__lang' key={lang.name}>
